...
class YoutubeVideo < ActiveHash::Base
  self.data = [
    ...
    },
    {
      ...
      embed_code: '<iframe src="https://www.youtube.com/embed/kQrFZ8e1E0g?" title="「春の海幻想」 【加東邦楽演奏会2021】" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen class="youtube mx-auto"></iframe>'
    },
    {
      id: 5,
      result_id: 2,
